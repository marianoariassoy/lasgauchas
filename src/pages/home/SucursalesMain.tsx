...
const SucursalesItem = ({ setActive }) => {
  return (
    <article
      className='flex productos-item'
      id='sucursales-main'
    >
      <div className='w-2/5'>
        <Image
        ...
        <div className='flex flex-col gap-y-16 max-w-3xl'>
          ...
          <div className='flex flex-col gap-y-3'>
            ...
            <p>
              ...
              salteños para una experiencia de maridaje perfecta. En Buenos Aires nos encontramos ubicados en el corazón
              de Bella Vista y pròximamente con una nueva sucursal en CABA
            </p>
          </div>
          <div className='flex justify-end'>
            <button
              ...
              onClick={() => setActive('sucursales-location')}
            >
              Ver ubicaciones
            </button>
          </div>
