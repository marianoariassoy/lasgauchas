...
const Clientes = () => {
  return (
    ...
    >
      <div
        className='grid grid-cols-1 lg:grid-cols-2 gap-12 mx-auto max-w-6xl items-center'
        id='clientes-main'
      >
        <div className='flex flex-col gap-y-12 lg:gap-y-28'>
          <h1 className='font-secondary text-6xl lg:text-8xl'>
         ...
         hover:text-black hover:bg-transparent text-sm lg:text-base'
            >
              Ver clientes
            </Link>
          </div>
